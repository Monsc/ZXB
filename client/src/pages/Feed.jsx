...
export const Feed = () => {
  ...
  // 新增顶部Tab状态
  const [activeTab, setActiveTab] = useState('following'); // 'following' or 'forYou'
  ...
  return (
    <div className="max-w-2xl mx-auto px-0 sm:px-4 pb-8">
      {/* 顶部栏 */}
      <div className="sticky top-0 z-20 bg-white/95 dark:bg-black/80 backdrop-blur border-b border-gray-200 dark:border-gray-800">
        <div className="flex flex-col">
          <div className="h-14 flex items-center px-4 font-bold text-xl text-gray-900 dark:text-white border-b border-transparent select-none">
            首页
          </div>
          <div className="flex border-b border-gray-200 dark:border-gray-800">
            <button
              className={`flex-1 py-3 font-bold text-base transition-colors border-b-2 ${activeTab === 'forYou' ? 'text-twitter-blue border-twitter-blue' : 'text-gray-500 border-transparent hover:bg-gray-100 dark:hover:bg-gray-900'}`}
              onClick={() => setActiveTab('forYou')}
            >
              为你推荐
            </button>
            <button
              className={`flex-1 py-3 font-bold text-base transition-colors border-b-2 ${activeTab === 'following' ? 'text-twitter-blue border-twitter-blue' : 'text-gray-500 border-transparent hover:bg-gray-100 dark:hover:bg-gray-900'}`}
