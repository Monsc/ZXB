...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-6 border border-twitter-blue/20 bg-white dark:bg-black p-7 shadow-2xl duration-200',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full opacity-90 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-twitter-blue focus:ring-offset-2 disabled:pointer-events-none bg-twitter-blue/10 p-2">
        <X className="h-6 w-6 text-twitter-blue" />
